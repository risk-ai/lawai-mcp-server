 ...
 */
export function classifyPracticeAreas(description: string): ClassificationResult[] {
 ...
 */
export function classifyComplexity(description: string): 'simple' | 'moderate' | 'complex' | 'high_stakes' {
  const lower = description.toLowerCase();
