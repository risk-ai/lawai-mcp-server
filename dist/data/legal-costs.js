...
exports.REGIONAL_ADJUSTMENTS = exports.LEGAL_COST_DATA = void 0;
exports.findCostData = findCostData;
exports.LEGAL_COST_DATA = [
    {
 ...
 */
function findCostData(practiceArea) {
    const lower = practiceArea.toLowerCase();
    return exports.LEGAL_COST_DATA.find(d => d.practice_area.toLowerCase() === lower ||
        d.practice_area.toLowerCase().includes(lower) ||
        lower.includes(d.practice_area.toLowerCase())) || null;
}
//# sourceMappingURL=legal-costs.js.map